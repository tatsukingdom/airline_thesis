...
************************************
*** 6-7. City All - Without ASVX ***
************************************
use "dta_clean/${dataset}_agg2_city", clear

drop if (inlist(carrier1, "AS", "VX") | inlist(carrier2, "AS", "VX") | inlist(carrier3, "AS", "VX") | inlist(carrier4, "AS", "VX"))
...
tsset market_id quarter, quarterly
save "dta_clean/${dataset}_agg3_city_nonASVX", replace
